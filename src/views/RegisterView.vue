<template>
    <div class="align-center justify-center" style="height: 100vh; width: auto; padding-top: 20vh;">
      <v-card class="mx-auto pa-12 pb-8" elevation="8" max-width="448" rounded="lg">
        ...
        <h1 :class="[cls, 'pa-4']">Register form</h1>
        <br>
  
        <v-sheet width="300" class="mx-auto">
          <v-form ref="form">
            <v-text-field label="Name" id="name"></v-text-field>
            <br>
            ...
            <div class="d-flex flex-column">
              ...
              <router-link to="/" class="text-blue text-decoration-none"><v-btn color="error"
              class="mt-4" block @click="reset">Back to Log-in</v-btn></router-link>
            </div>
          </v-form>
        </v-sheet>
      </v-card>
